...
def LH1_TrainModel(path_data):
    ...
    try:
        ...
        df_LH = df_LH.set_index('CronTime')
        ...
        average_by_day_shift = df_LH.groupby(["date", "shift"]).mean()
        df_LH = average_by_day_shift
        ...
        ### Huấn luyện mô hình Global
        # Huấn luyện mô hình MultiOutputRegressor với ExtraTreesRegressor
        model = MultiOutputRegressor(ExtraTreesRegressor(n_estimators=50, max_depth=10, n_jobs=2, random_state=42))
        ...
        path_best_model = f'D:/001.Project/LDA_master/autotrain/best/LH1_Optimizer_best.sav'
        path_best_evaluation = f'D:/001.Project/LDA_master/autotrain/best/LH1_Optimizer_best.txt'
        ...
        ### Huấn luyện mô hình Local
        # Huấn luyện mô hình KNN K=1
        ...
        # Đường dẫn lưu mô hình tốt nhất và file đánh giá
        path_best_model = f'D:/001.Project/LDA_master/autotrain/best/LH1_History_best.sav'
        path_best_evaluation = f'D:/001.Project/LDA_master/autotrain/best/LH1_History_best.txt'
...
def LH2_AutoRetrainingModel(PG_cursor):
    try:
        path_data = "D:/001.Project/LDA_master/data/DATA_LH2.csv"
        get_DATA_LH2(PG_cursor, path_data)
        LH2_TrainModel(path_data)
    except Exception as e:
        print(f"An error occurred: {e}")
        pass

def get_DATA_LH2(PG_cursor, path_data):
    """
        Export dữ liệu từ DB về local
        1. Workflow:
            - Giai đoạn 1: Query data DATA_CTCN
    ...
    try:
        ...
        df_LH2.to_csv(path_data, index=False)
    except Exception as e:
        print(f"An error occurred: {e}")
        pass

def LH2_TrainModel(path_data):
    """
        Huấn luyện mô hình dự đoán dựa trên dữ liệu từ file CSV
        1. Workflow:
            - Giai đoạn 1: Đọc và tiền xử lý dữ liệu từ file CSV
    ...
    try:
        ...
        # Lọc dữ liệu dựa trên ngưỡng của cột FT1151_DIVA_OUT__Value (0.12 đến 0.16)
        df_LH = df_LH[(df_LH['FT1151_DIVA_OUT__Value'] <= 0.16) & (df_LH['FT1151_DIVA_OUT__Value'] >= 0.12)]
        df_LH = df_LH[(df_LH['AZ1011ZT_DACA_PV__Value'] >= 90)]
        ...
        # Đường dẫn lưu mô hình tốt nhất và file đánh giá
        path_best_model = f'D:/001.Project/LDA_master/autotrain/best/LH2_Optimizer_best.sav'
        path_best_evaluation = f'D:/001.Project/LDA_master/autotrain/best/LH2_Optimizer_best.txt'
        ...
        # Đường dẫn lưu mô hình tốt nhất và file đánh giá
        path_best_model = f'D:/001.Project/LDA_master/autotrain/best/LH2_History_best.sav'
        path_best_evaluation = f'D:/001.Project/LDA_master/autotrain/best/LH2_History_best.txt'
